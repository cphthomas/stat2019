...
\addcontentsline{toc}{chapter}{Stat2}
...
Dette er undervisningsmateriale og opgaver til faget statistik, for
erhvervsakademierne.
...
ikke bare postnummer, boligform, men også etage.
...
\hypertarget{freestat}{%
\subsubsection{Freestat}\label{freestat}}

Man kan få beregnet deskriptorerne i et utal af programmer heriblandt
Freestat et gratis program, der kan hentes ved at klikke på billedet.
Freestat kan gennemføre de mest almindelige statistiske analyser.
...
hente et hypotese mindmap ved at klikke på billedet til højre: \_\_\_
...
datasæt}\label{uni--bi--og-multivariate-datast}}
...
\chapter{Indledning}\label{indledning}}
 ...
 Dette er noter og opgaver til faget statistik, for erhvervsakademierne.
...
\hypertarget{freestat-1}{%
\subsubsection{Freestat}\label{freestat-1}}
